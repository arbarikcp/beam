package com.arb.pardo;

import com.arb.schema.SalesRecord_v2;
...
public class Filtering {
    ...
    private static class FilterHeaderFn extends DoFn<String, String> {
        ...
        /**
         *
         * We can use any one of the approach of processElement() defined below.
         */
...
/*        @ProcessElement
        ...
        public void processElement(@Element String line, OutputReceiver<String> out) {
            if (!line.isEmpty() && !line.equals(this.header)) {
                out.output(line);
            }
        }
    }
