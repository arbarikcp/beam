...
public class FixedWindow_v2 {
    ...
    public static void main(String[] args) {
        ...
        PCollection<String> res =  output.apply(ParDo.of(new DoFn<KV<String, Long>, String>() {
        ...
        res.apply(TextIO.write().to("src/main/resources/sink/output").withWindowedWrites());
